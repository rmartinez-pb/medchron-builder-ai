...
const App: React.FC = () => {
  ...
  const allEvents: TimelineEvent[] = documents
             ...
             <div className="h-full flex flex-col md:flex-row gap-6">
                ...
                <div className="flex-1 bg-white rounded-xl shadow-sm border border-slate-200 flex flex-col overflow-hidden">
                   ...
                   <div className="flex-1 overflow-hidden p-4">
                      <TimelineView events={(selectedDocument.entities || []).map(e => ({...e, sourceDocumentId: selectedDocument.id, sourceDocumentName: selectedDocument.name, id: uuidv4()}))} />
                   </div>
                </div>
             </div>
           ) : (
